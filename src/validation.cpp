...
#if defined(NDEBUG)
# error "gorillcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "gorillcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s GTH additional fees, %d delta bytes\n",
